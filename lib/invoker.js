...
module.exports = function(options) {
  ...
  awsOptions.httpOptions.timeout = 5000;
  ...
  return function(req, res, next) {
    ...
    awsRequest
      .on('error', function(err) {
        ...
        return next(Error.create("Error invoking lambda function",
          _.extend(err, {functionName: functionName})));
      })
