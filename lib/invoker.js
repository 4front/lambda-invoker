...
module.exports = function(options) {
  ...
  awsOptions.maxRetries = 3;
  awsOptions.httpOptions.timeout= 60 * 3;
  ...
  return function(req, res, next) {
    var payload = _.pick(req, 'body', 'query', 'cookies', 'params', 'method', 'path');

    // Tack on environment variables to the payload
    payload.env = req.ext.env;
